          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-1">
              ...
              <p className="text-zinc-300 font-light leading-relaxed mb-6">
                Sorteamos los tres traslados para la ruta icónica para grupos de 1 a 4 personas: <strong className="text-white font-medium">Ciudad de Guatemala ➔ Antigua ➔ Panajachel ➔ Ciudad de Guatemala</strong>. Ampliaremos mas detalles en nuestras historias de instagram de Blvck Sheep.
              </p>
