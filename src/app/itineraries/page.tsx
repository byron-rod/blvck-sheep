...
export default function ItinerariesPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white pt-24 pb-20 px-6 md:px-12 lg:px-24 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <section aria-labelledby="itineraries-heading">
          <h2 id="itineraries-heading" className="sr-only">
            {activeLanguage === "en" ? "Available Itineraries" : "Itinerarios Disponibles"}
          </h2>
        ...
        <section className="mt-32 pt-24 border-t border-zinc-900" aria-labelledby="approach-heading">
          <p className="text-xs uppercase tracking-[0.3em] text-zinc-500 mb-4" aria-hidden="true">
            {activeLanguage === "en" ? "The Blvck Sheep Approach" : "El Enfoque Blvck Sheep"}
          </p>
          <h2 id="approach-heading" className="text-4xl md:text-5xl font-light tracking-tight mb-16">
            {activeLanguage === "en" ? "Beyond Transportation" : "Más Allá del Transporte"}
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <article className="bg-zinc-950 border border-zinc-800/50 p-10 rounded-2xl hover:bg-zinc-900 hover:border-zinc-700 transition-colors duration-500">
              <Map strokeWidth={1} className="w-8 h-8 text-zinc-400 mb-6" aria-hidden="true" focusable="false" />
            ...
            <article className="bg-zinc-950 border border-zinc-800/50 p-10 rounded-2xl hover:bg-zinc-900 hover:border-zinc-700 transition-colors duration-500">
              <Home strokeWidth={1} className="w-8 h-8 text-zinc-400 mb-6" aria-hidden="true" focusable="false" />
              <h3 className="text-xl font-medium mb-4">
            ...
            <article className="bg-zinc-950 border border-zinc-800/50 p-10 rounded-2xl hover:bg-zinc-900 hover:border-zinc-700 transition-colors duration-500">
              <Compass strokeWidth={1} className="w-8 h-8 text-zinc-400 mb-6" aria-hidden="true" focusable="false" />
              <h3 className="text-xl font-medium mb-4">
          ...
          <div className="mt-20 flex justify-center">
            <Link 
              ...
              aria-label={activeLanguage === "en" ? "Craft Your Custom Route via WhatsApp" : "Diseña tu Ruta Personalizada por WhatsApp"}
